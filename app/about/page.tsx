    ...
    <div className="bg-white">
      ...
      <main className="isolate">
        ...
        <div className="relative isolate -z-10">
          <svg
            className="absolute bg-slate-950 inset-x-0 top-0 -z-10 h-[64rem] w-full flex stroke-gray-200 [mask-image:radial-gradient(32rem_32rem_at_center,white,transparent)]"
            aria-hidden="true"
          >
            <defs>
              <pattern
